...
describe('Job e2e test', () => {
    ...
    it('should load Jobs', () => {
        ...
        expect(jobComponentsPage.getTitle())
            .toMatch(/contractsApp.job.home.title/);
    ...
    it('should load create Job dialog', () => {
        ...
        expect(jobDialogPage.getModalTitle())
            .toMatch(/contractsApp.job.home.createOrEditLabel/);
        jobDialogPage.close();
    });

    it('should create and save Jobs', () => {
        jobComponentsPage.clickOnCreateButton();
        jobDialogPage.setTitleInput('title');
        expect(jobDialogPage.getTitleInput()).toMatch('title');
