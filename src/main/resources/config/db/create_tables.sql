...
-- Index: idx_city_name_country_id

-- DROP INDEX public.idx_city_name_country_id;

CREATE UNIQUE INDEX idx_city_name_country_id
    ON public.city USING btree
    (name COLLATE pg_catalog."default", country_id)
    TABLESPACE pg_default;
